...
const STANDARD_MESSAGES: Record<ErrorCode, string> = {
  ...
  AUTH_CONFIG_MISSING:
    "Calitoy Content auth is not configured. Follow the README setup steps for Cloudflare Access.",
  PAYMENT_REQUIRED:
    "An active hosted subscription is required before you can use Calitoy Content.",
