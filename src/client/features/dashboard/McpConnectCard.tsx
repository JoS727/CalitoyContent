...
function firstPrompts(domain: string | null): string[] {
  ...
  return [
    `Review ${site}. Ideas for what keywords we could target? Use Calitoy Content`,
    "Research my competitors top pages and keywords and tell me what's working. Use Calitoy Content",
  ];
}
        ...
        {connected ? (
          ...
          <>
            <div className="space-y-2 text-sm text-base-content/70">
              <p>
                Calitoy Content is designed to give your AI agent the data it needs to
