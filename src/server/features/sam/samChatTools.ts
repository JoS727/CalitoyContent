 ...
 * free site-reading tools. Every tool the Calitoy Content MCP server exposes is
...
export function buildSamMcpTools(
  ...
  return {
    ...
    get_product_info: tool({
      description:
        "The Calitoy Content fact sheet: what the product does, plans/pricing, credit costs, integrations, MCP setup. Call before answering questions about Calitoy Content itself. Uses no credits.",
      inputSchema: z.object({}),
